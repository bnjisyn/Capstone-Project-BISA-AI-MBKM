...
<body>
        ...
        <div class="container box_1620">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-end">
              ...
              <!-- <li class="nav-item"><a class="nav-link" href="#kontak" rel="page-scroll">About Us</a></li> -->
            </ul>
          </div> 
        </div>
      </nav>
  ...
  <main class="side-main">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 pt-5">
            <div class="hero-banner__content">
              ...
              <p>
                  Proyek ini dibuat oleh tim beranggotakan 3 orang yang bertujuan untuk 
                  mengaplikasikan dan memanfaatkan hybrid cloud storage pada sistem kehadiran 
                  yang nantinya bisa diaplikasikan penggunaannya pada suatu perusahaan / startup.
              </p>
            </div>
          </div>
        </div>
    ...
    <section class="section-margin">
      <div class="container">
        <div class="section-intro text-center" id="kontak">
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <h3 class="card-feature__title text-center">Benjamin Nikholas</h3><br>
                <img src="./img/photo_profile/foto_benji.jpeg"
            ...
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                <span class="card-feature__icon"></span>
                <h3 class="card-feature__title text-center">Kasih Chyntia</h3><br>
                <img src="./img/photo_profile/foto_chyntia.jpg"
                style="border-radius: 50%;">
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                <span class="card-feature__icon"></span>
                <h3 class="card-feature__title text-center">Rama Aldiansyah</h3><br>
                <img src="./img/photo_profile/foto_rama.jpeg"
                style="border-radius: 50%;">
              </div>
            </div>
          </div>
